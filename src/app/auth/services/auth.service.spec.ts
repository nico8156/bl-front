...
describe('Auth Service', () => {
    ...
    describe('login', ()=> {
        it('logs in ',()=> {
            ...
            const req = HttpTestingModule.expectOne('http://localhost:8080/api/auth/login')
    ...
    describe('register', () => { 
        ...
        it('registers some user', () => {
            ...
            const req = HttpTestingModule.expectOne('http://localhost:8080/api/auth/register')
            req.flush(fakeResponse)
            expect(req.request.method).toBe('POST')
        })
    })
    describe('getCurrentUser', () => { 
        ...
        it('returns the user logged in ', () => {
            ...
            const req = HttpTestingModule.expectOne('http://localhost:8080/api/auth/user')
            req.flush(fakeResponse)
    ...
    describe('update', () => { 
        ...
        it('returns the user logged in ', () => {
            ...
            const req = HttpTestingModule.expectOne('http://localhost:8080/api/auth/update')
            req.flush(fakeResponse)
